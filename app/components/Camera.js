...
export default class CameraEx extends React.Component {
        ...
        return (
            <View style={{ flex: 1, justifyContent: 'space-around', alignItems: 'center', flexDirection: 'row' }}>
                <View style={{textAlign: 'center', alignItems: 'center'}}>
                    <TouchableOpacity style={{ alignItems: 'center', justifyContent: 'center', backgroundColor: '#1E90FF', width: 30, height: 30, borderRadius: 100, }} onPress={() => this.zoomOut()} >
                        <Text style={{
                            fontSize: 30,
                            textAlign: 'center',
                            color: 'black',
                ...
                <View style={{textAlign: 'center', alignItems: 'center'}}>
                    <TouchableOpacity style={{ alignItems: 'center', justifyContent: 'center', backgroundColor: 'grey', width: 30, height: 30, borderRadius: 100, }} onPress={() => { this.state.flashMode === Camera.Constants.FlashMode.on ? this.setState({ flashMode: Camera.Constants.FlashMode.off, flashTxt: 'Off' }) : this.setState({ flashMode: Camera.Constants.FlashMode.on, flashTxt: 'On' }) }}>
                    <Text style={{
                            fontSize: 15,
                            textAlign: 'center',
                            color: 'black',
                ...
                <View style={{textAlign: 'center', alignItems: 'center'}}>
                    ...
                    <TouchableOpacity style={{ alignItems: 'center', justifyContent: 'center', backgroundColor: '#1E90FF', width: 30, height: 30, borderRadius: 100, }} onPress={() => this.zoomIn()}>
                        <Text style={{
                            fontSize: 30,
                            textAlign: 'center',
                            color: 'black',
    ...
    render() {
        console.log('Render ===> hora h ', this.state.currentPrivewId)
                    ...
                    <View style={{ flex: 1 }}>
                        ...
                        <View
                            ...
                            <View style={{
                                ...
                                <TouchableOpacity onPress={() => this.capture()} style={{ backgroundColor: 'grey', borderWidth: 2, borderColor: 'white', alignItems: 'center', borderRadius: 100, height: 75, width: 75 }} />
                            </View>
                            <View style={{
                                flex: 1,
                                alignItems: 'center',
